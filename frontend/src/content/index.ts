...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    photo: u('photo-1508214751196-bcfd4ca60f91', 200),
  },
  {
  ...
  {
    text: 'Three vans for a busy tech conference, every pickup precise to the minute. Our CFO now refuses anyone else.',
    name: 'Priya Raghavan',
    location: 'Operations Director · Brickell',
    rating: 5,
    photo: u('photo-1534528741775-53994a69daeb', 200),
  },
  {
    text: 'Last-minute booking at 11 PM for an early cruise transfer. Confirmed in ten minutes, flawless morning pickup.',
    name: 'James O’Connor',
    location: 'Cruise client · PortMiami',
    rating: 5,
    photo: u('photo-1472099645785-5658abf4ff4e', 200),
  },
  {
    text: 'They drove my parents to every appointment for a month, always patient and never a minute late. True professionals.',
    name: 'Carolina Mendez',
    location: 'Private client · Hialeah',
    rating: 5,
    photo: u('photo-1544005313-94ddf0286df2', 200),
  },
  {
    text: 'Hourly service while shopping in Design District — the car waited, doors opened, and the vibe was pure Miami luxury.',
    name: 'Daniel Brooks',
    location: 'Hourly client · Miami',
    rating: 4,
    photo: u('photo-1506794778202-cad84cf45f1d', 200),
  },
]
